...
/**
 * Servlet implementation class EditScenarioData
 */
@WebServlet("/editScenarioData")
public class EditScenarioData extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditScenarioData() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TestScenario tc = new TestScenario(scenarioID,"","",scenarioName,scenarioCode,desc,isActiveval,false,null);	
